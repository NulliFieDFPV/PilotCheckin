...
--
-- Host: localhost:3306
-- Erstellungszeit: 10. Mai 2018 um 16:18
...
--
ALTER TABLE `traceoptions`
  MODIFY `ROID` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=6;
--
...
--
ALTER TABLE `trfid`
  MODIFY `RFIDID` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=9;
--
-- AUTO_INCREMENT für Tabelle `twaitlist`
--
ALTER TABLE `twaitlist`
  MODIFY `WID` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=1227;
